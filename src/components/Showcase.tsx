...
const techStack = [
  ...
  { name: "C", icon: "https://cdn.simpleicons.org/c/00599C", color: "#00599C" },
  { name: "HTML", icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmSeg_oDuZrUSIjUEKBlSz_pJSwhC7C4x19kkmwXPLeQ&s", color: "#E34C26" },
  ...
  { name: "Oracle SQL", icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8utW214eQvjYzsUULfvtyPQbUm3191GVMgKeKRC6lDg&s=10", color: "#F80000" },
  { name: "AWS", icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDHiPUi-lNJWWinNZKC_llj9-jpaTmgZIX6AJyBRO1IA&s", color: "#FF9900" },
...
const projects = [
  {
    tech: "Handwriting and text analyzer",
    thumbnail: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=900&q=80",
    github: "https://github.com/pavanshetty09/Handwriting-and-text-analyser.git",
  },
  {
    tech: "React + Node.js",
  ...
  {
    tech: "Land secure using blockchain technology",
    thumbnail: "https://images.unsplash.com/photo-1639762681057-408e52192e55?auto=format&fit=crop&w=900&q=80",
    github: "https://github.com/pavanshetty09/Land-s-Records-secure-using-Blcokchain-Technology.git",
  },
  {
    tech: "Grama-vaxi",
    thumbnail: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=900&q=80",
    github: "https://github.com/pavanshetty09/Grama-Vaxi.git",
  },
];

const certificates = [
  { title: "AWS Cloud Virtual Internship", tech: "AWS", thumbnail: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=900&q=80", downloadUrl:"/certificate1.pdf" },
  { title: "Python Essentials 2", tech: "Python", thumbnail: "https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=900&q=80",downloadUrl:"/certificate2.pdf"  },
  { title: "NoSQL MongoDB - IBM", tech: "MongoDB", thumbnail: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=900&q=80" ,downloadUrl:"/certificate3.pdf"},
  { title: "AI-ML Virtual Internship", tech: "AI/ML", thumbnail: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=900&q=80",downloadUrl:"/certificate4.pdf" },
  { title: "React JS - Infosys Springboard", tech: "React", thumbnail: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=900&q=80",downloadUrl:"/certificate5.pdf" },
];
...
function CertCard({ item }: { item: typeof certificates[0] }) {
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      link.href = item.downloadUrl || "/certificate.pdf";
