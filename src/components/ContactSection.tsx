...
export default function ContactSection() {
    ...
    animate-[shine_4s_linear_infinite]"
                            >
                                Interested in software development, automation, AI, or cloud projects?
                                Send me a message and let's build something practical,
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:pavanshetty09112004@gmail.com"
                ...
                hover:shadow-[0_0_25px_rgba(255,255,255,0.12)]"
                    ...
                    group-hover:opacity-100 transition-opacity duration-300"
                            ...
                            {/* whatsapp */}
                            <a
                                href="PS D:\Pavan\portfolio> git remote add origin https://github.com/pavanshetty09/Portfolio.git    
error: remote origin already exists."
                ...
                hover:shadow-[0_0_30px_rgba(34,197,94,0.25)]"
                    ...
                    group-hover:opacity-100 transition-opacity duration-300"
                            ...
                            <a
                                href="https://www.linkedin.com/in/paramesh888"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl
                border border-white/10
                ...
                hover:shadow-[0_0_30px_rgba(59,130,246,0.25)]"
                            >
                                <FaLinkedin
                                    className="text-white/80 group-hover:text-blue-400
                    text-[18px] sm:text-[20px]
                    transition-all duration-300"
                                />
                            </a>
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        {/* Instagram */}
                        <a
                            href="https://www.instagram.com/_charming_crush?igsh=MTVzYXU2M3dxeGhqMg%3D%3D&utm_source=qr"
                            target="_blank"
                            rel="noopener noreferrer"
    ...
    hover:-translate-y-1.5 hover:scale-105 hover:border-white/30"
                        ...
                        {/* GitHub */}
                        <a
                            href="https://github.com/pavanshetty09"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-red-400/50"
                        ...
                        {/* Telegram */}
                        <a
                            href="https://t.me/PAVANSHETTY092004"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Telegram"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
