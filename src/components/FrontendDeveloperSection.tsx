...
<motion.span
  ...
  className="text-white/60 font-mono ml-1"
>
  |
</motion.span>
          ...
          <motion.span
            ...
            className="text-white/60 font-mono ml-[4px]"
          >
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Building software solutions with strong problem-solving skills, clean architecture, and practical engineering. I enjoy web development, machine learning, automation, and cloud-focused projects.
        </motion.p>
        ...
        >
          {["Python", "HTML", "Javascript", "Tailwind CSS"].map((tech) => (
            <div
              key={tech}
              className="
