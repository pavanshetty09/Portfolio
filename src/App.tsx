...
const logos = ["PARAMESH", "SOFTWARE", "AI", "CLOUD"];
          ...
          >
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-between px-6 md:px-12 pt-24 pb-10">
              <h1
                ...
                className={`font-display uppercase leading-[0.8] tracking-[-0.03em] text-[clamp(3rem,8vw,7rem)] md:text-[clamp(4.5rem,10vw,8.5rem)] lg:text-[clamp(6rem,11vw,9.5rem)] cursor-pointer transition-all duration-300 ${colors[colorMode]}`}
              >
                {displayed || "\u00A0"}
              </h1>
...
animate-[shine_4s_linear_infinite]">
    ...
    from-white via-white/60 to-white
    animate-[shine_4s_linear_infinite]">
                  Turning ideas into reliable software, modern web experiences, and smart automation.{" "} <br />
                  <em className="not-italic text-white">
                    Python, C, React, and cloud-ready solutions.
                  </em>
                </p>
